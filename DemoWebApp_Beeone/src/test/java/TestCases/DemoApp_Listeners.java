...
import Utilities.ExtendReport_TestNG;
import automationCore.BaseClass;

public class DemoApp_Listeners extends BaseClass implements ITestListener {

	
	 ExtentTest test;
	 ExtendReport_TestNG extentReport= new ExtendReport_TestNG();
